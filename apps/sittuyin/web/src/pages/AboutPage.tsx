...
/** What Sittuyin is, and how to help the project on GitHub (sit-010). */
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-5">
      ...
      <Card className="flex flex-col gap-3" data-testid="contribute">
        <h2 className="flex items-center gap-2 text-lg font-extrabold">
          <Heart aria-hidden className="h-5 w-5 text-danger" />
          {t('about.openSource')}
        </h2>
        ...
        {/* One column: the Burmese labels are long and would wrap inside narrow buttons. */}
        <div className="grid gap-3">
          ...
          <ExternalLink href={`${REPO_URL}/blob/main/apps/sittuyin/docs/i18n-review.md`}>
