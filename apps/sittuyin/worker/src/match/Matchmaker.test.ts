...
describe('Sittuyin quick match (sit-008)', () => {
  it('pairs two players into a Sittuyin room whose clocks wait for the setup', async () => {
    const a = await guest();
    const b = await guest();
