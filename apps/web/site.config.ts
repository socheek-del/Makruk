 ...
 * When moving domains also update `apps/worker/wrangler.jsonc` (`routes`, `PUBLIC_ORIGIN`) and the `[play]`
 * link at the bottom of README.md / README.th.md, then resubmit the sitemap in Google Search Console.
 */
