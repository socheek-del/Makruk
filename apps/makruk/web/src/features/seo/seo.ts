/**
 * seo-001: per-page title, description, canonical URL and language alternates for the Makruk site. The
 * head-tag writing and language URLs are shared (@chaturanga/game-shell); pages and languages are Makruk's.
 */
import {
