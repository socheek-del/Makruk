...
import { type RoomEnv, USER_HEADER } from './GameRoomBase';
 ...
 *
 * It creates rooms through the product's own GAME_ROOM namespace, so the pairing is variant-agnostic.
 */
export class MatchmakerBase<E extends RoomEnv> extends DurableObject<E> {
