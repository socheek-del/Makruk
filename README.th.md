...
<img src="apps/web/public/og-image.png" alt="หมากรุกไทย · Makruk" width="100%" />
...
ดูคำอธิบายทีละขั้นได้ในบทเรียนในแอปและใน [`docs/rules.md`](docs/rules.md)
...
| แพ็กเกจ | หน้าที่ |
|---|---|
| [`packages/engine`](packages/engine) | เอนจินกติกาหมากรุกไทยด้วย TypeScript ล้วน สร้างตาเดิน นับศักดิ์ FEN และ perft ตรวจเทียบกับ Fairy-Stockfish |
...
| [`apps/web`](apps/web) | แอป React PWA ทั้งกระดาน บทเรียน เล่นสองคน และหน้าเล่นออนไลน์ |
| [`apps/worker`](apps/worker) | Cloudflare Worker และ Durable Objects สำหรับห้องเกม นาฬิกา และระบบจับคู่ |
...
- 🐛 [รายงานบั๊กหรือเสนอไอเดีย](https://github.com/socheek-del/Makruk/issues/new)
- 🇹🇭 คนไทยช่วยตรวจถ้อยคำภาษาไทยได้ที่ [`docs/i18n-review.md`](docs/i18n-review.md)
- ♟️ เล่นหมากรุกไทยเก่ง ช่วยตรวจบทเรียนและ [`docs/rules.md`](docs/rules.md)

## สัญญาอนุญาต

[GPL-3.0-or-later](LICENSE) © ผู้ร่วมพัฒนา Makruk ภาพหมาก มาสคอต และภาพประกอบทั้งหมดสร้างขึ้นสำหรับโปรเจกต์นี้
