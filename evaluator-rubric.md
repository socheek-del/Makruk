...
| UX & design | Does it follow the "Wat" design system (`docs/design.md`: own palette, Prompt font, pill buttons, focused game screen), avoid copying other products' trade dress, and work at ~400px width? |  |  |
